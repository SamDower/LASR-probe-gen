    ...
    for i in range(len(tr)):
        ...
        for j in range(len(ts)):
            search_dict = {
                ...
                "behaviour": tr[i][1],
                "train/datasource": tr[i][2],
                "train/generation_method": tr[i][4],
                "train/response_model": tr[i][5],
                "test/datasource": ts[j][1],
                "test/generation_method": ts[j][3],
                "test/response_model": ts[j][4],
